	...
	def jq_config = {
		try{
			...
			if(!company.wlconfig){
				...
				def wlConfignew = new ConfigurationApp(app:company?.companyName.toString(),mailSecret:wlConfigdefault.mailSecret ,
					...
					applePassword:wlConfigdefault.applePassword  ,isEnable:true,
					hasZoneActive:false,hasMobilePayment:false,endlessDispatch:false,digitalRadio:false,mailkey: wlConfigdefault.mailkey ,driversProfileEditable:true)
				wlConfignew.save()
