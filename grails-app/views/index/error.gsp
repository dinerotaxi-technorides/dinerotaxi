...
<div class="mainContent">
    ...
    <div class="bOX1055 mt10">
                         ...
                         <div class="mens_error"><p>Ha ocurrido un error , lo estaremos reportando <br />
	<a href="#" title="Atencion al usuario(Acceso por teclado: u)" accesskey="r">Muchas Gracias por usar DineroTaxi.com</a></p></div>
       </div>
